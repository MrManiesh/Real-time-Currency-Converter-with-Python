...
logo = ImageTk.PhotoImage(Image.open('expert.png'))
root.iconphoto(False, logo)


# Creating a Heading for the window
Label(root, text='Currency Converter (@expert.py)', font=('Comic Sans MS', 18), bg='black', fg='white').place(x=70)
...
Label(root, text='Convert from:', font=('Georgia', 13, 'italic'), bg='black', fg='white').place(x=60, y=60)
...
Label(root, text='Convert to:', font=('Georgia', 13, 'italic'), bg='black', fg='white').place(x=330, y=60)
